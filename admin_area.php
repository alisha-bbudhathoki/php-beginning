...
if($_SESSION['admin_level']<1){
    ...
    echo '<p>You are beign redirected to the main page.If your browser '.
        'doesn\'t redirect you automatically, <a href="main.php">click' . 'here </a>.</p>';
    die();
}
include 'db.inc.php';
...
<table style="widht:708">
    <tr><th>Username</th><th>First Name</th><th>Last Name</th></tr>
    <?php
    $query= 'SELECT 
    u.user_id, username, first_name, last_naem
    FROM
    site_user u JOIN
